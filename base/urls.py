...
urlpatterns = [
    ...
    path('delete-activity/<str:pk>/', views.UserDeleteActivityLog, name = 'delete-activitylog'),
    path('delete-achievement/<str:pk>/', views.UserDeleteAchievement, name = 'delete-achievement'),
